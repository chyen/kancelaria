@section('head')
<head>
    <title>Kancelaria Adwokacka Pawelczyk</title>
    @include('layout.master-css')
    @include('layout.master-fonts')
    ...
    <meta content="Kancelaria Adwokacka Pawelczyk Adwokata Janusza Pawelczyk świadczy pomoc prawną,
          ...
          oraz osób prywatnych ceniących sobie bezpieczeństwo, komfort, jak również dyskrecję w realizacji powierzonych zadań." name="keywords"/>
</head>
@show